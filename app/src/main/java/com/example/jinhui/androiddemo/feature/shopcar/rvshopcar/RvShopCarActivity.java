 ...
 *
 * https://github.com/19snow93/ShopCartLogic
 */
public class RvShopCarActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rvshopcar);
    ...
    private void initView() {
        ...
        // 实时监控全选按钮
        mShopCartAdapter.setOnRefreshListener(new ShopCartAdapter.OnRefreshListener() {
            @Override
